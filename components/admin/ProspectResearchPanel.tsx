    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center gap-2">
        {editable ? (
          <input
            ...
            className="font-serif text-xl text-[#111111] rounded-xl border border-[#111111]/15 px-3 py-1.5 outline-none focus:border-[#063b32]"
          />
        ) : (
          <h2 className="font-serif text-xl text-[#111111]">{data.organisation_name}</h2>
        )}
      ...
      <div className="rounded-xl border border-[#111111]/10 bg-[#063b32]/5 p-4">
        <Field
          ...
          editable={editable}
          multiline
          onChange={(v) => patch({ need_rationale: v })}
        />
      </div>
      ...
      {(data.sector_tags.length > 0 || data.pain_point_tags.length > 0) && (
