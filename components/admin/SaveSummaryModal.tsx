    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl">
        ...
        <div className="space-y-3 px-5 py-4">
          <div>
            <label className="mb-1 block text-xs font-semibold text-[#6f6b62]">Title</label>
            <input
              value={title}
          ...
          <div>
            <label className="mb-1 block text-xs font-semibold text-[#6f6b62]">Summary</label>
            <textarea
              value={summary}
              onChange={(e) => setSummary(e.target.value)}
              rows={10}
              className="w-full resize-y rounded-lg border border-[#111111]/15 px-3 py-2 text-sm leading-relaxed outline-none focus:border-[#063b32] max-h-[50vh]"
        ...
        <div className="flex justify-end gap-2 border-t border-[#111111]/10 px-5 py-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-[#063b32] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1a5c42] disabled:opacity-50"
          >
