...
const actionClass =
  "flex items-center gap-1.5 rounded-lg border border-[#111111]/12 bg-white px-3.5 py-2 text-sm font-semibold text-[#111111] shadow-sm transition-colors hover:bg-white/80";
