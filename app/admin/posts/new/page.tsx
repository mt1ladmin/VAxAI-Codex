  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex shrink-0 items-center gap-3 border-b border-pine-900/10 bg-white px-4 py-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            disabled={saving}
            className="rounded-xl bg-pine-900 px-4 py-2 text-sm font-semibold text-white hover:bg-pine-800 disabled:opacity-50"
          >
            Publish…
          </button>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden bg-cream/40">
        ...
        {/* Publish panel */}
        {panelOpen && (
          <div className="flex w-80 shrink-0 flex-col border-l border-pine-900/10 bg-white shadow-sm">
