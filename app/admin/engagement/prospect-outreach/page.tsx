        ...
        {meta ? (
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-5">
            <div className="rounded-2xl border border-pine-900/10 bg-white px-4 py-3 shadow-sm">
              ...
              <p className="mt-1 text-2xl font-semibold tabular-nums text-pine-900">{meta.total_count.toLocaleString()}</p>
            </div>
            <div className="rounded-2xl border border-pine-900/10 bg-white px-4 py-3 shadow-sm">
              <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-muted">Have tasks</p>
              <p className="mt-1 text-2xl font-semibold tabular-nums text-pine-900">{(meta.with_tasks_count ?? 0).toLocaleString()}</p>
            </div>
            <button
              type="button"
            ...
            >
              ...
              <p className="mt-1 text-2xl font-semibold tabular-nums text-pine-900">{(meta.preparing_to_engage_count ?? 0).toLocaleString()}</p>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <p className="mt-1 text-2xl font-semibold tabular-nums text-pine-900">{(meta.engagement_started_count ?? 0).toLocaleString()}</p>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <p className="mt-1 text-2xl font-semibold tabular-nums text-pine-900">{(meta.opportunity_identified_count ?? 0).toLocaleString()}</p>
            </button>
          </div>
        ) : null}
