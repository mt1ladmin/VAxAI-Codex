...
export default function JefPolicyPage() {
  return (
    <PolicyPage title="JEF Policy" lastUpdated="June 2025">
      ...
      <ul>
        <li>Who benefits?</li>
        <li>Who carries the risk?</li>
        <li>Whose needs and working realities have been considered?</li>
        <li>Who might be excluded, disadvantaged or placed under greater pressure?</li>
        <li>What would make the support fair, practical and trusted?</li>
      </ul>
      <p>
      ...
      <p>
        Social mobility matters to us, and we are deliberate about what we mean by it. We define
        social mobility as:
      </p>
      ...
      <p>
        This work is never finished. We keep listening, learning and improving, and we welcome
        challenge.
      </p>
      <p>
        We review this policy and our practice regularly, and we will update it as our work and
        understanding develops. If you have feedback on this policy or how we work, please email{" "}
        <a href="mailto:hello@mt1l.com">hello@mt1l.com</a>.
      </p>
