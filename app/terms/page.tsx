...
export default function TermsPage() {
  return (
    <PolicyPage title="Terms of Service" lastUpdated="June 2025">
      ...
      <p>
        1.1 VAxAI is a service provided by MT1L (&ldquo;MT1L&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;). These terms govern the relationship between us and any individual or organisation (&ldquo;you&rdquo;, &ldquo;your&rdquo;, &ldquo;the Client&rdquo;) that engages our services or uses this website.
      </p>
      <p>
      ...
      <p>In these terms:</p>
      <ul>
        <li><strong>&ldquo;Engagement&rdquo;</strong> means any piece of work, project or ongoing service we agree to provide, as set out in a written Proposal.</li>
      ...
      <p>
        10.2 For details of how we collect, use and protect personal information, see our <a href="/privacy">Privacy Policy</a>.
      </p>
      <p>
      ...
      <h2>14. General</h2>
      <p>
        14.1 <strong>Entire agreement.</strong> These terms, together with the relevant Proposal, constitute the entire agreement between the parties on the subject matter and supersede all prior discussions and agreements.
      </p>
      <p>
        14.2 <strong>Variation.</strong> No variation is effective unless agreed in writing by both parties.
      </p>
      <p>
        14.3 <strong>Waiver.</strong> Failure to exercise any right or remedy does not constitute a waiver of it.
      </p>
      <p>
        14.4 <strong>Severance.</strong> If any provision is found invalid or unenforceable, it will be severed to the minimum extent necessary and the remaining provisions continue in full effect.
      </p>
      <p>
      ...
      <p>
        14.6 <strong>Changes.</strong> We may update these terms from time to time. The version that applies to an Engagement is the one in effect when the Proposal is agreed. The current version is always published here with the date above.
      </p>
