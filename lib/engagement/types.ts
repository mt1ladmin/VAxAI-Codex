...
/** Studio palette badges — pine / acid / soft borders */
export const BADGE_COLORS: Record<string, string> = {
  Confirmed: 'bg-acid/70 text-ink',
  Hypothesis: 'bg-pine-100 text-pine-800',
  'Needs evidence': 'bg-white text-pine-800 border border-pine-900/15',
  'Human review': 'bg-red-50 text-red-700 border border-red-100',
  Sensitive: 'bg-red-50 text-red-700 border border-red-100',
  'Quick win': 'bg-acid text-ink',
  'Process first': 'bg-pine-50 text-pine-900',
  'Existing tool': 'bg-pine-100 text-pine-800',
  Integration: 'bg-pine-900/10 text-pine-900',
  Automation: 'bg-pine-900/10 text-pine-900',
  'AI-assisted': 'bg-acid/50 text-ink',
  'VA support': 'bg-pine-900 text-paper',
  approved: 'bg-acid/70 text-ink',
  draft: 'bg-white text-muted border border-pine-900/12',
  'needs review': 'bg-pine-100 text-pine-800',
  archived: 'bg-white text-muted border border-pine-900/10',
};

/** Studio palette: pine scale + acid for positive milestones */
export const STAGE_COLORS: Record<string, string> = {
  Identified: 'bg-white text-muted border border-pine-900/12',
  Researching: 'bg-pine-50 text-pine-800',
  'Ready to contact': 'bg-pine-100 text-pine-900',
  Contacted: 'bg-pine-900/10 text-pine-900',
  'Response received': 'bg-pine-900/15 text-pine-900',
  'Discovery booked': 'bg-acid/50 text-ink',
  'Discovery completed': 'bg-acid/70 text-ink',
  'Workflow review proposed': 'bg-pine-100 text-pine-800',
  'Proposal sent': 'bg-pine-900/10 text-pine-900',
  'Decision pending': 'bg-pine-100 text-pine-800',
  Won: 'bg-pine-900 text-paper',
  'Onboarding planned': 'bg-acid/40 text-ink',
  'Contract sent': 'bg-pine-900/10 text-pine-900',
  'Invoices sent': 'bg-pine-100 text-pine-800',
  'Onboarding in progress': 'bg-acid/60 text-ink',
  Onboarding: 'bg-acid/50 text-ink',
  'Active client': 'bg-pine-900 text-paper',
  Nurture: 'bg-white text-pine-800 border border-pine-900/15',
  Paused: 'bg-white text-muted border border-pine-900/10',
  Lost: 'bg-red-50 text-red-700 border border-red-100',
  'Not suitable': 'bg-white text-muted border border-pine-900/10',
};
...
/** Studio palette: pine-900, acid, white, ink — no rainbow chrome */
export const PROSPECT_QUEUE_STATUS_COLORS: Record<string, string> = {
  'Contact attempted': 'bg-pine-900/10 text-pine-900',
  'No response': 'bg-white text-muted border border-pine-900/12',
  'Conversation held': 'bg-acid/70 text-ink',
  'Follow up required': 'bg-pine-100 text-pine-800',
  'Opportunity identified': 'bg-pine-900 text-paper',
  'Not suitable': 'bg-white text-muted border border-pine-900/10',
};
